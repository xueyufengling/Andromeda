...
function(add_target target_name binary_type)
	...
	if(${result})
		if(${ARGC} EQUAL 0)
			...
			message(FATAL_ERROR "imported excutable cannot have args but found '${ARGN}', target '${target_name}' add failed")
		endif()
	...
	if(${result})
		if(${ARGC} EQUAL 0)
			...
			message(FATAL_ERROR "global imported excutable cannot have args but found '${ARGN}', target '${target_name}' add failed")
		endif()
	...
	if(${result})
		if(${ARGC} EQUAL 1)
			...
			message(FATAL_ERROR "invalid original target '${ARGN}', executable alias target '${target_name}' add failed")
		endif()
	...
	if(${result})
		if(${ARGC} EQUAL 0)
			...
			message(FATAL_ERROR "object library cannot have args but found '${ARGN}', target '${target_name}' add failed")
		endif()
	...
	if(${result})
		if(${ARGC} EQUAL 0)
			...
			message(FATAL_ERROR "imported library cannot have args but found '${ARGN}', target '${target_name}' add failed")
		endif()
	...
	if(${result})
		if(${ARGC} EQUAL 0)
			...
			message(FATAL_ERROR "global imported library cannot have args but found '${ARGN}', target '${target_name}' add failed")
		endif()
	...
	if(${result})
		if(${ARGC} EQUAL 1)
			...
			message(FATAL_ERROR "invalid original target '${ARGN}', library alias target '${target_name}' add failed")
		endif()
	...
	if(resolved_type)
		...
		printmsg(blue "add ${descp} target '${target_name}'")
	else()
...
macro(__add_sources_foreach__ visibility src)
	...
	string(JOIN "\n   " src_files ${SOURCES})
	printmsg(green "source files list:\n   " ${src_files})
endmacro()
