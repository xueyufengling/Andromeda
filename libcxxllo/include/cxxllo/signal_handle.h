#ifndef _CXXLLO_SIGNAL_HANDLE
#define _CXXLLO_SIGNAL_HANDLE
 ...
 * @brief 指定信号的处理
 */
extern void handle_signal(system_signal sig, signal_handler handler, int priority = 0);
