#ifndef _CXXGCTX_GL_VERTEXATTRIBUTE
#define _CXXGCTX_GL_VERTEXATTRIBUTE
...
class vertex_attribute_info //属性的信息
{
	...
	friend class cxxcomm::array<vertex_attribute_info>;
...
private:
	...
	{
		type_size = cxxgctx::gl::sizeof_gl_type(type);
	}
...
private:
	...
	cxxcomm::array<vertex_attribute_info> attribs;
...
#endif//_CXXGCTX_GL_VERTEXATTRIBUTE
