#ifndef _CXXGCTX_GL_DOUBLEFRAMEBUFFER
#define _CXXGCTX_GL_DOUBLEFRAMEBUFFER

#include <cxxsci/color_rgba.h>
#include <cxxgctx/gl/framebuffer.h>
...
private:
	...
	double_framebuffer(int width, int height, cxxsci::color_rgba clearColor = {0, 0, 0, 0}) :
...
#endif//_CXXGCTX_GL_DOUBLEFRAMEBUFFER
