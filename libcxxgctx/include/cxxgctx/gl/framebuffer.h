#ifndef _CXXGCTX_GL_FRAMEBUFFER
#define _CXXGCTX_GL_FRAMEBUFFER
...
namespace gl
{
class framebuffer: public cxxgctx::gl::gl_object<framebuffer>
{
private:
...
public:
	 ...
	 */
	framebuffer(int width, int height, cxxsci::color_rgba clear_color = {0, 0, 0, 0}) :
			width(width), height(height), clear_color(clear_color)
	{
		set_clear_color(clear_color);
	}

	inline void set_clear_color(cxxsci::color_rgba clear_color = {0, 0, 0, 0})
	{
		this->clear_color = clear_color;
	}

	inline cxxsci::color_rgba get_clear_color()
	{
		return clear_color;
	}
