#ifndef _CXXGCTX_GL_TEXTURE2D
#define _CXXGCTX_GL_TEXTURE2D
...
class texture2d: public cxxgctx::gl::gl_object<texture2d>
{
private:
	const char* texture_path = nullptr;
	texture_type type = texture_type::NONE;
	cxxmmproc::raster_image image;
...
public:
	...
	texture2d(cxxmmproc::raster_image img, texture_type type = texture_type::UNKNOWN) :
			image(img), type(type)
	{
	}
	...
	__attribute__((always_inline)) inline void set_image(cxxmmproc::raster_image img)
	{
		image = img;
	}
	...
	{
		image = cxxmmproc::raster_image::read(img_path);
